    ...
    extends PathValueOperation
{
     ...
     * @param overwriteExisting whether the operation is allowed to overwrite
     *                          an existing value at the specified path
     */
    protected AdditionOperation(final String op, final JsonPointer path,
        final JsonNode value, final boolean overwriteExisting)
    {
        super(op, path, value);
